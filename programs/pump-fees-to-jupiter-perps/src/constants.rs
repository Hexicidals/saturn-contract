...
pub const JUPITER_INCREASE_REQUEST_SIDE_OFFSET: usize = 24;
pub const JUPITER_INCREASE_REQUEST_MINIMUM_OUT_OPTION_OFFSET: usize = 33;
pub const JUPITER_INCREASE_REQUEST_WITH_MINIMUM_OUT_LEN: usize = 50;
pub const JUPITER_INCREASE_REQUEST_WITHOUT_MINIMUM_OUT_LEN: usize = 42;
